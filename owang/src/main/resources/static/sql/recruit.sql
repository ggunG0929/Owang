...
* 아르바이트 채용
* 경험자 우대
* 주말 근무 가능자 우대', '2023-09-16 14:30:00', '2023-09-23 14:30:00', 7, 1, 320, '새마을식당'),
('saema', '한국의 맛을 세계로! [새마을] 요리사 채용 중', '새마을에서 함께할 조리 스태프를 모집합니다. 다음은 채용 상세 정보입니다.
* 채용인원: 2명
* 급여: 협의
* 아르바이트 채용
* 조리 경험자 우대
* 주말 근무 가능자 우대', '2023-09-16 11:00:00', '2023-09-23 11:00:00', 7, 1, 370, '새마을식당'),
('saema', '[새마을]에서 함께할 요리사를 찾습니다. 지원하세요', '새마을에서 함께할 주방 보조 스태프를 모집합니다. 다음은 채용 상세 정보입니다.
* 채용인원: 2명
* 급여: 협의
* 아르바이트 채용
* 경험자 우대
* 주말 근무 가능자 우대', '2023-09-16 14:30:00', '2023-09-23 14:30:00', 7, 1, 300, '새마을식당'),
('saema', '[새마을] 주방 보조 스태프 채용합니다.', '새마을에서 함께할 주방 보조 스태프를 모집합니다. 다음은 채용 상세 정보입니다.
* 채용인원: 2명
* 급여: 협의
* 아르바이트 채용
* 경험자 우대
* 주말 근무 가능자 우대', '2023-09-16 12:15:00', '2023-09-23 12:15:00', 7, 1, 350, '새마을식당'),
('saema', '[새마을] 한식의 맛을 함께 만들어갈 [새마을] 요리사 모집 ', '새마을에서 함께할 조리 스태프를 모집합니다. 다음은 채용 상세 정보입니다.
* 채용인원: 1명
* 급여: 협의
* 아르바이트 채용
* 조리 경험자 우대
* 주말 근무 가능자 우대', '2023-09-16 15:45:00', '2023-09-23 15:45:00', 7, 1, 280, '새마을식당'),
('saema', '[새마을] 서빙 스태프 모집합니다.', '새마을에서 함께할 서빙 스태프를 찾고 있습니다. 다음은 채용 상세 정보입니다.
* 채용인원: 3명
* 급여: 협의
* 아르바이트 채용
* 경험자 우대
* 주말 근무 가능자 우대', '2023-09-16 09:30:00', '2023-09-23 09:30:00', 7, 2, 380, '새마을식당');
